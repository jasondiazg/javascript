...
function sumar() {
    alert("numero + numeroEnCadena es " + (2 + "5") + " typeof " + typeof(2 + "5"));
}
...
function mostrarArregloEnConsola(arreglo) {
...
function relacionalIn() {
    ...
    if ("length" in miCadena) { // devuelve true (length es una propiedad del String)
        console.log("Length si es una propiedad de un string por lo tanto si existe");
    }

    // Objetos creados
    var carro = {marca: "Honda", modelo: "Civic", fecha: 2008};
    if ("marca" in carro) {
